...
const reservationNotificationsBody = stripMigrationTransaction(readFileSync(join(process.cwd(), "db/init/006_reservation_notifications.sql"), "utf8"));
...
export async function POST(req: Request) {
  try {
    ...
    try {
      ...
      await client.query(reservationNotificationsBody);
